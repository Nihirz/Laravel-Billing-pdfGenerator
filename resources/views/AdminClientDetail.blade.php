                    ...
                    <div class="card-body row">
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered"
                            ...
                            <tr >
                                ...
                                <td>
                                    <a href="{{route('edit.product',$clientproduct->id)}}"  class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size: 15px"></i></a>
                                    <a href="{{route('delete.products',$clientproduct->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash-o" aria-hidden="true" style="font-size: 15px"></i></a>
